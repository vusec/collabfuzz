...
pub const PASS_NAME: &str = "instr_counter";

pub struct InstructionCounterPass {
...
impl Pass for InstructionCounterPass {
    fn pass_type(&self) -> PassType {
        PassType::InstructionCounter
    }
