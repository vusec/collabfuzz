; RUN: %opt_icount %s -icount-args-abi -icount-abilist=%S/Inputs/abilist.txt -S | FileCheck %s
...
; CHECK: %[[CALL:.*]] = call { i32 (i32, i32)*, i16 } @"icount$g"(i32 %0, i16 0)
...
; CHECK: define linkonce_odr { i32, i16 } @"icountw$custom2"(i32, i32, i16, i16)
; CHECK: %[[LABELRETURN2:.*]] = alloca i16
; CHECK: %[[RV:.*]] = call i32 @__icountw_custom2
...
; CHECK: define linkonce_odr void @"icountw$custom3"(i32, i16, i16*, ...)
; CHECK: call void @__icount_vararg_wrapper(i8*
; CHECK: unreachable
...
define void @f(i32 %x) {
  ...
  ; CHECK: call void @__icountw_custom1(i32 1, i32 2, i16 zeroext 0, i16 zeroext 0)
  call void @custom1(i32 1, i32 2)

  ; CHECK: call i32 @__icountw_custom2(i32 1, i32 2, i16 zeroext 0, i16 zeroext 0, i16* %[[LABELRETURN]])
  call i32 @custom2(i32 1, i32 2)

  ; CHECK: call void @__icountw_customcb({{.*}} @"icountt0$customcb", i8* bitcast ({{.*}} @"icount$cb" to i8*), i16 zeroext 0)
  ...
  ; CHECK: call void (i32, i16, i16*, ...) @__icountw_custom3(i32 1, i16 zeroext 0, i16* %[[LABELVA1_0A]], i32 2, i32 %{{.*}})
  ...
  ; CHECK: call i32 (i32, i16, i16*, i16*, ...) @__icountw_custom4(i32 1, i16 zeroext 0, i16* %[[LABELVA2_0A]], i16* %[[LABELRETURN]], i32 2, i32 3)
...
define i32 (i32, i32)* @g(i32) {
  ; CHECK: ret {{.*}} @"icountw$custom2"
  ret i32 (i32, i32)* @custom2
}

; CHECK: define { i32, i16 } @"icount$adiscard"(i32, i32, i16, i16)
...
; CHECK: declare void @__icountw_custom1(i32, i32, i16, i16)
; CHECK: declare i32 @__icountw_custom2(i32, i32, i16, i16, i16*)

; CHECK-LABEL: define linkonce_odr i32 @"icountt0$customcb"(i32 (i32)*, i32, i16, i16*)
...
; CHECK: declare void @__icountw_custom3(i32, i16, i16*, ...)
; CHECK: declare i32 @__icountw_custom4(i32, i16, i16*, i16*, ...)
